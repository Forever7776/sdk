...
public class SendMail {
	...
	public static void send_common() throws Throwable {
		...
		// 添加收件人
		receiver.addTo("305389431@qq.com");
		// 添加抄送
		//receiver.addCc("forever7776@163.com");
		// 添加密送
		//receiver.addBcc("life_system@163.com");

		MailBody body = new MailBody();
		// 设置 From
		body.setFrom("forever7776@163.com");
		// 设置 FromName
		body.setFromName("lifes77");
		// 设置 ReplyTo
		body.setReplyTo("forever7776@163.com");
		// 设置标题
		body.setSubject("注册账号");
		// 创建文件附件
		//body.addAttachments(new File("http://ob2dt6f5q.bkt.clouddn.com/x1.jpg?imageslim"));
		//body.addAttachments(new File("D:/2.png"));
		//// 创建流附件
		 body.addAttachments(new BufferedInputStream( new URL("http://ob2dt6f5q.bkt.clouddn.com/x1.jpg?imageslim").openStream()),"x1");

		TextContent content = new TextContent();
		content.setContent_type(ScContentType.html);
		content.setText("<html><p>您的验证码为：8888</p></html>");
